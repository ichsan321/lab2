...
import 'loginscreen.dart'; // pemanggil setelah loading splashscreen baru ke login

void main() => runApp(SplashScreen()); // metod untuk splas screen

class SplashScreen extends StatelessWidget {
  // stateles widget untuk banyak class
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: new ThemeData(
          primarySwatch:
              MaterialColor(0XFF00ACC1, color)), // UNTUK WARNA PADA KOLOM
      ...
      home: Scaffold(
        body: new Container(
          ...
          child: Column(
            mainAxisAlignment:
                MainAxisAlignment.center, // tata letak loaing screen
            children: <Widget>[
              Image.asset(
    ...
    return new Center(
      ...
      child: LinearProgressIndicator(
        ...
        valueColor: new AlwaysStoppedAnimation<Color>(
            Color.fromRGBO(40, 206, 209, 1)), // warna pada bar loading
      ),
    ));
  }
}
